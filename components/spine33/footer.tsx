        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a 
                href="https://www.facebook.com/profile.php?id=61586912152085"
                target="_blank"
              ...
              <a 
                href="https://www.instagram.com/spine33_clinic/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#1a0000] border border-gray-300 hover:bg-[#f9c722] hover:border-[#f9c722] transition-colors"
              ...
              <a 
                href="https://www.youtube.com/@spine33clinic"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#1a0000] border border-gray-300 hover:bg-[#f9c722] hover:border-[#f9c722] transition-colors"
                aria-label="Youtube"
              ...
              <a 
                href="https://share.google/k0Z8Wb82SgHnX9OvI"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#1a0000] border border-gray-300 hover:bg-[#f9c722] hover:border-[#f9c722] transition-colors"
